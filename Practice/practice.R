...
'''
demo_table2 <- fromJSON(txt='R_Statistical_Analysis/Practice/Resources/demo.json')

'''{r}
demo_table3 <- read.csv(file='../Bootcamp/Week15_R/R_Statistical_Analysis/Practice/Resources/demo2.csv',check.names=F,stringsAsFactors = F)
'''
...
> geom_errorbar(aes(ymin=Mean_Engine-SD_Engine,ymax=Mean_Engine+SD_Engine)) #overlay with error
bars
'''
#visualize the different vehicle fuel e􀂨ciency ratings by manufacturer
'''{r}
...
'''{r}
> population_table <- read.csv(file='R_Statistical_Analysis/Practice/Resources/used_car_data.csv',check.names = F,stringsAsFactors = F) #import used car dataset
...
# pair t-test
'''{r}
> population_table <- read.csv(file='R_Statistical_Analysis/Practice/Resources/mpg_modified.csv',check.names = F,stringsAsFactors = F) #import used car dataset
...
# pair t-test
'''{r}
used_cars <- read.csv(file='R_Statistical_Analysis/Practice/Resources/used_car_data.csv',check.names = F,stringsAsFactors = F)
head(used_cars)
